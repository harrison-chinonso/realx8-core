...
app.get('/health', (req, res) => res.json({ service: 'services/investment-service', status: 'ok' }));
app.use('/', routes);
app.use(notFound);
...
const bootstrap = async () => {
  ...
  await syncIfSchemaChanged(models.sequelize, { serviceName: 'investment-service', logger });
  /**
